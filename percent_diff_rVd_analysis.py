...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 14 21:15:34 2021
...
data = pd.read_csv('/home/schubham/Thesis/Thesis/Data/percent_diff_accepted_rVd_Clusters(step_5,chisqlim_3)_test.csv')
data.iloc[0]
del_Lx = data['Lx']
del_Ysz = data['Ysz']
del_T = data['T']
...
data = pd.read_csv('/home/schubham/Thesis/Thesis/Data/rVd_percent_diff_(all+clusters).csv')
