...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  6 17:03:04 2021
...
# =============================================================================
# del_Lx_range = np.arange(0,160,5)
# del_T_range = np.arange(-70,30,5)
# del_Ysz_range = np.arange(-90,75,5)
# del_R_range = np.arange(-90,-20,5)
# del_Lbcg_range = np.arange(-65,70,5)
# =============================================================================


# Test : dividing the loop into multiple parts and running them individually
step = 5
del_Lx_range = np.arange(100,160,step)
        ...
        for k in del_Ysz_range:
            for l in del_R_range:
                for m in del_Lbcg_range:
                    ...
                    ((1_diff_t_x)**(1/b))-1
                    #uncertainty from x 
                    ((np.log(1+diff_x)*((1+diff_x)**(b))*sig_b)**2. )**(1./2.)
