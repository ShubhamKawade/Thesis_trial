...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec  8 00:43:45 2021
...
data = pd.read_csv('/home/schubham/Thesis/Thesis/Data/percent_diff_accepted_ccVncc_Clusters(step_5_chsqlim_3).csv')
data.iloc[0]
del_Lx = data['Lx']
del_Ysz = data['Ysz']
del_T = data['T']
...
best_norm_all = data['best_Norm_clusters']
best_slope_all = data['best_Slope_clusters']
err_slope_all = data['err_bestslope_clusters']
...
plt.title('Norm difference in CC-NCC (Clusters)(step : 5%, $\chi^{2}_{red}$ lim : 3)')
